  ...
  return (
    <div className="bg-[#f7f2ee] py-16">
      <div className=" text-center space-y-5 mb-5">
        <h2 className="text-4xl">MY TRAVEL ESSENTIALS</h2>
        <p className="text-[#838383] text-lg">We are the Backpack Traveler, your favorite travel assistants!</p>
      </div>
